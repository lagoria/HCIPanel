...
#define BLE_DEVICE_NAME      "ESP32_BLEFI"    //The Device Name Characteristics in GAP
#endif
...
/// Characteristic UUID
#define	TEST_CHAR_GATT_UUID					0xFF01	
...
static uint8_t raw_adv_data[] = {
    ...
    0x03, 0x03, 0xFF, 0x00,
    /* device name */
    0x0c, 0x09, 'E', 'S', 'P', '3', '2', '_', 'B', 'L', 'E', 'F', 'I',
};
...
static const uint16_t test_custom_uuid = TEST_CHAR_GATT_UUID;
static const uint8_t  test_char_val[1] = {0x00};
static const uint8_t  test_custom_ccc[2] = {0x00,0x00};
...
// 添加属性表特征声明
	[TEST_CUSTOM_CHAR]        =							//0x2803	特征声明
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ,
    CHAR_DECLARATION_SIZE,CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write_notify}},
	
	[TEST_CUSTOM_CHAR_VAL]         =							//0xFF01	自定义UUID
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&test_custom_uuid, ESP_GATT_PERM_READ|ESP_GATT_PERM_WRITE,
    sizeof(uint8_t), sizeof(test_char_val), (uint8_t *)test_char_val}},
	
	[TEST_CUSTOM_CHAR_CFG]         =							//0x2902	客户端配置特征
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ|ESP_GATT_PERM_WRITE,
    sizeof(uint16_t),sizeof(test_custom_ccc), (uint8_t *)test_custom_ccc}},
    ...
    switch (event) {
    	...
    	case ESP_GATTS_WRITE_EVT:
            ...
            if (!param->write.is_prep){
                ...
                if (gatt_handle_table[TEST_CUSTOM_CHAR_CFG] == param->write.handle && param->write.len == 2){
				...
				if(res == TEST_CUSTOM_CHAR_VAL)
				{
					ESP_LOGI(TAG, "TEST_CUSTOM_CHAR_VAL = %d",TEST_CUSTOM_CHAR_VAL);
					ESP_LOGI(TAG, "writing value = %d",param->write.value[0]);
				}
...
// void gatts_send_indicate(esp_gatt_if_t gatt_if, uint16_t conn_id, 
//                         uint8_t index, uint8_t *send_data, size_t data_len)
// {
//     esp_ble_gatts_send_indicate(gatt_if, conn_id, gatt_handle_table[index],
//                                 data_len, send_data, true);
// }
